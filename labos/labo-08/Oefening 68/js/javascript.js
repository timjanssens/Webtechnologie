...
let aantalMannen = 0;
let aantalVrouwen = 0;
let aantalOuderDanDertig = 0;

for (const person of demoData) {
...
text.textContent = "Er zijn " + aantalMannen + " mannen en " + aantalVrouwen + " vrouwen." +  "\r\n" + "Er zijn " + aantalOuderDanDertig + " personen ouder dan 30.";